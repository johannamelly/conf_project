...
if($result[0]['combien']==0){
 ...
 $json = json_encode( $request['date'] );
echo $json;
$result[0]['combien']=0;
}
array_push($tableau, $nom, $conference);
